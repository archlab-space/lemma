/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f21b16f0f861030a19ecd95a4b406031)
// Runtime types generated with workerd@1.20250906.0 2025-09-13 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		RATE_LIMIT_KV: KVNamespace;
		SUPABASE_URL: "https://hvbzrbfevhnytecmwbdw.supabase.co";
		SUPABASE_ANON_KEY: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh2YnpyYmZldmhueXRlY213YmR3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTgwNzUwODgsImV4cCI6MjA3MzY1MTA4OH0.8R2l6eSbHujd5CKO1xKh00JuCKGX8PeBBP2VOGKkOAM";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "BACKEND_URL">> {}
}
